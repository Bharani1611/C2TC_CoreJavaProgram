package com.tnif.DayFifteen.userdefinedobjects.comparableandcomparator;
...
public class ListD {
	...
	public static void main(String[] args) {
		...
		Student s1 = new Student(11, "Rakesh", 78);
		studentList.add(s1);
		s1 = new Student(21, "bharani", 85);
		studentList.add(s1);
		s1 = new Student(13, "Deepa", 68);
		studentList.add(s1);
		s1 = new Student(41, "Vikram", 72);
		studentList.add(s1);
